...
async function run() {
  try {
    const userCollection = client.db("Roni").collection("RoniDataMega");
    const userCollections = client.db("Roni").collection("RoniCodeMega");
...
app.get("/", (req, res) => {
  res.send("Helle from Roni Megapersonal");
});
